...
extension Clients {
  final class CloudChannelReportsServiceRetry: CloudChannelReportsServiceStub {
    let inner: any CloudChannelReportsServiceStub
    let options: GoogleGax.ClientOptions

    public init(_ inner: any CloudChannelReportsServiceStub, options: GoogleGax.ClientOptions) {
      self.inner = inner
